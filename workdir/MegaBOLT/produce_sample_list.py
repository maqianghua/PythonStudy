...
''' %(program_shortdesc, str(__date__))
    ...
    try:
        ...
        parser.add_argument("-a1","--adapter1",dest="adapter1",help="The adapter of read1",required=True)
        parser.add_argument("-a2","--adapter2",dest="adapter2",help="The adapter of read2",required=True)
