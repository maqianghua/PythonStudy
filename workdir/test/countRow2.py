...
# 代码所在目录
#FILE_PATH = './'
FILE_PATH='E:\Python\workdir'
def analyze_cod(codefilesource):
    '''
...
def run(FILE_PATH):
    ...
    for i in os.listdir(os.getcwd()):
        if os.path.splitext(i)[1] == '.txt':
            line = analyze_cod(i)
            total_lines, total_comment_lines, total_blank_lines = total_comment_lines + line[0], total_comment_lines + line[1], total_blank_lines + line[2]
